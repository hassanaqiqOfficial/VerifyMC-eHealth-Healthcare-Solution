...
(function ($) {
    ...
    var methods = {
        ...
        selectedDate: function (year, month, day) {

            if(year==0)
            {
                this.find(
                    '.jqyc-not-empty-td[data-day-of-month="' + day + '"].jqyc-not-empty-td[data-month="' + month + '"]'
                ).addClass('daySelected');
            }
            else
            {
                this.find(
        ...
        clearAllSelected: function (year, month, day) {
            this.find('.jqyc-not-empty-td').removeClass('daySelected');
            recalcHeight();
        },
    ...
    $.fn.calendar.defaults = {
        ...
        mode: 'classic',
        addUniqueClassOnClick: "selected",//false,
        l10n: {
            jan: "January",
            feb: "February",
            mar: "March",
    ...
    function createWholeCalendar(settings, $this) {
        ...
        $calendar.find('.jqyc-not-empty-td[data-day-of-month="' + choosenDayOfMonth + '"][data-month="' + choosenMonth + '"][data-year="' + choosenYear + '"]')
        ...
        while (d <= days) {
            ...
            if (i < firstDay) {
                ...
                monthHTMLString = monthHTMLString +
                    ...
                    + '" data-day-of-month="' + d + '" data-year="' + year + '"><span>' + d + ' </span></td>';
            }
            if (i % 7 == 0) {
