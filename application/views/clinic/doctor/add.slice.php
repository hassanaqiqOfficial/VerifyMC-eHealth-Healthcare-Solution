   ...
   <!-- Page header -->
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="d-flex page-title pb-2 pt-2">
                <h4> <span class="font-weight-semibold">Add Doctor</span></h4>
    ...
    <!-- Default grid -->
        <div class="card">
            ...
            <form action="<?=base_url('clinic/doctor/add'); ?>" method="post" class="admin-form-validate" id="myform">
                <div class="card-body">
                    <div class="form-row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="form-group row">
                              <label class="col-form-label col-lg-2 col-md-2">Phone <span class="text-danger dark"> * </span></label>
                                <div class="col-lg-8 col-md-8">
                                <input type="text" class="form-control phoneformate" name="phone" required value="" id="phone">
                            </div>
                           </div>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="form-group row">
                           ...
                           <div class="form-group row">
                             <label class="col-form-label col-lg-2 col-md-2">EIN</label>
                               <div class="col-lg-8 col-md-8">
                                <input type="text" class="form-control" name="controlled_license" value="" id="controlled_license">
                            </div>
                         </div>
                          ...
                          <div class="form-group row">
                           ...
                           <div class="form-group row">
                            <label class="col-form-label col-lg-2 col-md-2">Password <span class="text-danger dark"> * </span></label>
                                <div class="col-lg-8 col-md-8">
                                <input type="password" class="form-control" name="password" required value="" id="password" autocomplete="OFF">
                            </div>
                         </div>
                          ...
                          <div class="form-group row">
                             <label class="col-form-label col-lg-2 col-md-2">Confirm Password <span class="text-danger dark"> * </span></label>
                                <div class="col-lg-8 col-md-8">
                                <input type="password" class="form-control" name="confirm_password" required value="" id="confirm_password" autocomplete="OFF">
                            </div>
                        </div> 
                          ...
                          <div class="col-lg-12 col-md-12">
                            ...
                            <div class="form-group row"> 
                             <label class="col-form-label col-lg-1 col-md-1">Profile </label>
                               <div class="col-lg-10 col-md-10" style="padding-left: 22px;">
                                <textarea class="ckeditor" name="profile_info" id="profile_info">
                                </textarea>
                               </div>
                             </div>
                           ...
                           <div class="form-group row">
                             <label class="col-form-label col-lg-1 col-md-1">Upload Image</label>
                              <div class="col-md-10 col-lg-10" style="padding-left: 22px;">
