     ...
     <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="d-flex page-title pb-2 pt-2">
                <h4> <span class="font-weight-semibold">Manage Patients</span></h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="<?=base_url("clinic/patient/add");?>" class="btn btn-outline-primary btn-sm" ><span>Add Patient</span></a>
...
<?php
    $column = array(
        ...
        "five"=>array("search"=>'false',"sort"=>'false'),
        "three"=>array("search"=>'true',"sort"=>'true'),
        "four"=>array("search"=>'true',"sort"=>'true'),
        "six"=>array("search"=>'true',"sort"=>'true'),
        "seven"=>array("search"=>'true',"sort"=>'true'),
        "eight"=>array("search"=>'true',"sort"=>'true'),
        "nine"=>array("search"=>'false',"sort"=>'false'),
    );
?>
...
$(document).ready(function() {
    ...
    patient_datatable = $("#datatable").DataTable({
        ...
        responsive: true,
            "ajax": {
            "url" : "<?= base_url("clinic/patient/list_patient")?>",
            "type": "POST",
            "data": function ( d ) {
                 d.custom_filter = '';
            }
