        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="<?=base_url("clinic/appointment/add_appointment/".$doctor_id); ?>" class="btn btn-outline-primary btn-sm" ><span>Add Appointment</span></a>
                </div>
            </div>
...
<section class="content">
  ...
  <?=__message()?> 
    <div class="card-body">
        <table class="table" id="datatable"width="100%">
            ...
            <thead>
            <tr>
                <th width="8%"><input type="checkbox" disabled></th>
  ...
  <?php
    $column = array(
        ...
        "qtwo"=>array("search"=>'false',"sort"=>'false'),
...
$(document).ready(function() {
    ...
    doctor_datatable = $("#datatable").DataTable({
        ...
        responsive: true,
            "ajax": {
            "url" : "<?=base_url('clinic/appointment/list_appointment/'.$doctor_id)?>",
            "type": "POST",
            "data": function ( d ) {
                 d.custom_filter = '';
            }
