    ...
    <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="d-flex page-title pb-2 pt-2">
                    <h4> <span class="font-weight-semibold">Edit Appointment</span></h4>
         ...
         <div class="card">
           <?=__message()?>
             <div class="card-body">
                ...
                <form class="form-groups-bordered" id="myform" action="<?=base_url('clinic/appointment/edit_appointment/'.$appointment['pk_appointment_id'].'/'.$doctor_id);?>" method="post" enctype="multipart/form-data" id="myform">
                    <div class="row mt25">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div class="row">
                              <div class="col-md-12 col-sm-12 col-lg-12">
                                ...
                                <label class="form-input-label">Patient</label>
                                   <input type="text" name="patient_name" class="form-control" placeholder="Patient Name" disabled value="<?=$appointment['patient_fname'].' '.$appointment['patient_lname']?>">
...
<!--                            </div>-->
                            ...
                            <div class="row mt5">
                                ...
                                <div class="form-group">
                                    <label>Date</label>
                                    <input type="text" id="datepicker1" value="<?=date("m/d/Y",strtotime(strstr($appointment['appointment']," ",true)));?>" placeholder="Select Date" class="form-control">
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row mb15">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="app_category" class="form-control" id="">
                                        ...
                                        foreach ($categories as $category) {
                                            ...
                                            ?>
                                            <option value="<?=$category['pk_app_categoryid'];?>" <?php if($appointment['fk_app_categoryid'] == $category['pk_app_categoryid']){echo "selected";}?> ><?=$category['name'];?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="app_status" class="form-control" id="">
                                        <option value="0" <?php if($appointment['status_appointment'] == 0){echo "selected"; }?> >Pending</option>
                                        <option value="1" <?php if($appointment['status_appointment'] == 1){echo "selected"; }?> >Active</option>
                                    </select>
                                </div>
                                </div>
                        ...
                        <?php if($scheduled_notifications){ ?>
                         
                        <h4 class="title" style="font-weight:bold;">Scheduled Appointment Notifications</h4>
                           <hr style="margin-top:9px;margin-bottom: 16px;">
                            Scheduled notifications are listed for both patient and physician as following below. (Any of the following scheduled notifications can be removed to scheduled new one).
                               ...
                               <div class="row mt-2">
                                  <div class="col-lg-6 col-md-6">
                                      ...
                                      <div class="row">
                                        <div class="col-md-12 col-lg-12">
                                            <label>
                                                <i class="fa fa-user mr-1"></i>Patient Scheduled Notifications
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12 col-lg-12">
                                            <div class="form-group">
                                                <?php
                                                   ...
                                                   {
                                                   if($notification['send_to'] == 0 && $notification['type'] == 1){
                                                ?>

                                                <a onclick="confirmbox('Are you sure you want to Delete this Appointment notification?','<?=base_url('doctor/appointment/delete_appointment_notification/'.$notification['pkscheduler_id'].'/'.$notification['fkappointment_id']); ?>');" style="color:#1a1a1a;">
                                                    <span data-toggle="tooltip" title="Email Notification"><i class="fa fa-trash-o mr-1 cursor-pointer" style="color:red;"></i><?=$notification['task']; ?></span><br>
                                                </a>
                                                <?php }elseif($notification['send_to'] == 0 && $notification['type'] == 0){ ?>

                                                <a onclick="confirmbox('Are you sure you want to Delete this Appointment notification?','<?=base_url('doctor/appointment/delete_appointment_notification/'.$notification['pkscheduler_id'].'/'.$notification['fkappointment_id']); ?>');" style="color:#1a1a1a;">
                                                    <span data-toggle="tooltip" title="SMS Notification"><i class="fa fa-trash-o mr-1 cursor-pointer" style="color:red;"></i><?=$notification['task']; ?></span><br>
                                                </a>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12">
                                            <label>
                                                <i class="fa fa-user mr-1"></i>Physician Scheduled Notifications
                                            </label>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                <?php
                                                   if($scheduled_notifications){
                                                      foreach($scheduled_notifications as $notification)
                                                      {
                                                        if($notification['send_to'] == 1 && $notification['type'] == 1){
                                                            ?>
                                                      <a onclick="confirmbox('Are you sure you want to Delete this scheduled notification?','<?=base_url('doctor/appointment/delete_appointment_notification/'.$notification['pkscheduler_id'].'/'.$notification['fkappointment_id']); ?>');" style="color:#1a1a1a;">
                                                          <span data-toggle="tooltip" title="Email Notification"><i class="fa fa-trash-o mr-1 cursor-pointer" style="color:red;"></i><?=$notification['task']; ?></span><br>
                                                      </a>
                                                      <?php }elseif($notification['send_to'] == 1 && $notification['type'] == 0){ ?>
                    ...
                    <hr>
                  <button type="submit" class="btn btn-sm btn-primary" style="margin-left:9px;" form="myform">Submit</button>
