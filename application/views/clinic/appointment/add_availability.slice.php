  ...
  <style type="text/css">
    ...
    <div class="tab-content" style="border-bottom:0px; border-left:0px; border-right:0px; border-radius:5px;">
       ...
       <div id="tab1" class="tab-pane fade active show" style="padding-left:20px; border-radius:5px;">
         <form action="<?php base_url('clinic/appointment/add_availability/');?>" method="post" accept-charset="utf-8" class="form-horizontal1 form-groups validate invoice-edit" enctype="multipart/form-data">
           <div class="form-row">
             <div class="col-md-12 col-sm-12">
               ...
               <div class="form-group row" style="margin-top:20px;">
                ...
                <div class="form-group row">
                 <label for="field-1" class="col-form-label col-sm-3 col-md-3">Select Date</label>
    
                 <div class="col-sm-8 col-md-8 col-lg-8">
                  <input type="text" class="form-control daterange-single " name="month_date[]" value="" autocomplete="off" id="datepicker1">
                </div>
               </div>
                ...
                <div class="form-group row">
                  <label for="field-1" class="col-form-label col-sm-3 col-md-3"></label>
                  <button type="button" class="btn btn-outline-primary btn-sm btn-icon icon-left" onclick="add_entry()" style="margin-left:15px;">
                          + Add Date<i class="entypo-plus"></i>
                   </button>
                </div>
                <?php
}
            ...
            <input type="hidden" name="entry_type" id="app_type" value="0">
               <?php
                 if($type == 0)
                 {
                  ?>
                  <input type="hidden" name="day_type" value="-1">
             ...
             <div id="tab2" class="tab-pane" style="padding-left:17px;">
              ...
              <div class="col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control daterange-single2" name="month_date[]" value="" autocomplete="off" id="datepicker1">
              </div>
             </div>
              ...
              <div class="form-group row">
                  <label for="field-1" class="col-form-label col-sm-3 col-md-3"></label>
                  <button type="button" class="btn btn-outline-primary btn-sm btn-icon icon-left" onclick="add_entry_2(this)" id="hide" style="margin-left:15px;">
                      + Add Date<i class="entypo-plus"></i>
                  </button>
               </div>
             <?php } ?>
