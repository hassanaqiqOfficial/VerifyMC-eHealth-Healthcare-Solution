			...
			<ul class="navbar-nav" style="margin-left:auto;">
				...
				<li class="nav-item dropdown dropdown-user">
					<a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
					    <img src="<?=base_url('assets/img/adminimg.jpg'); ?>" height="36" width="36" class="rounded-circle mr-2" alt="">
						<span><?=$_username;?></span>
					</a>
                    <div class="dropdown-menu dropdown-menu-right">
						<a href="<?=base_url("admin/profile")?>" class="dropdown-item"><i class="icon-user-plus"></i> My profile</a>
						<a href="<?=base_url("admin/profile")?>" class="dropdown-item"><i class="icon-cog5"></i> Account settings</a>
			...
			<div class="sidebar-content">
						...
						<div class="media">
							<div class="mr-3">
							  <a href="<?=base_url('admin/profile/'); ?>">
								<img src="<?=base_url('assets/img/adminimg.jpg'); ?>" height="38" width="38" class="rounded-circle" alt="">
							  </a>
							</div>
							...
							<div class="ml-3 align-self-center">
								<a href="<?=base_url('admin/profile/'); ?>" class="text-white"><i class="icon-cog3"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="<?=base_url('admin/'); ?>" class="nav-link <?php if(@$active == 'dashboard'){echo "active";} ?>">
                        ...
                        <li class="nav-item nav-item-submenu <?php if(@$active == 'clinics'){echo "nav-item-expanded nav-item-open";} ?>">
							<a href="javascript:void(0);" class="nav-link <?php if(@$active == 'clinics'){echo "active";} ?>" ><i class="fa fa-h-square"></i> <span>Clinics</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Clinics">
							   <li class="nav-item "><a href="<?=base_url("admin/clinics/add")?>" class="nav-link <?php if(@$active_page == 'clinics_add'){echo 'active';}?>"></i> Add Clinic</a></li>
                               <li class="nav-item "><a href="<?=base_url("admin/clinics/")?>" class="nav-link <?php if(@$active_page == 'clinics'){echo 'active';}?>"></i> Manage Clinics</a></li>
							</ul>
						</li>
                        ...
                        <li class="nav-item nav-item-submenu <?php if(@$active == 'doctors'){echo "nav-item-expanded nav-item-open";} ?>">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Doctors">
								<li class="nav-item "><a href="<?=base_url("admin/doctors/add")?>" class="nav-link <?php if(@$active_page == 'doctors_add'){echo 'active';}?>"></i> Add Doctor</a></li>
								<li class="nav-item "><a href="<?=base_url("admin/doctors/")?>" class="nav-link <?php if(@$active_page == 'doctors'){echo 'active';}?>">Manage Doctors</a></li>
							</ul>
						</li>
