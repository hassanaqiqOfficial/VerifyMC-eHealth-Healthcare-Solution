                      ...
                      <div class="form-row">
                            ...
                            <div class="form-group row">
                              <label class="col-form-label col-md-2 col-lg-2" style="font-size:14px;">Enter Category Name</label>
                                <div class="col-lg-6 col-md-6">
                                  <input type="text" name="app_category_name"  placeholder="Category Name" class="form-control">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="app_cat_color" id="light_red" value="#FFEDED_#736A6B_Light Red">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="app_cat_color" id="light_orange" value="#FFEEDA_#736A6B_Light Orange">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="app_cat_color" id="light_blue" value="#E8F2FE_#736A6B_Light Blue">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="app_cat_color" id="light_purple" value="#F6EDFF_#736A6B_Light Purple">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="app_cat_color" id="light_green" value="#EFF9EE_#736A6B_Light Green">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="app_cat_color" id="light_yellow" value="#FEFFDB_#736A6B_Light Yellow">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="app_cat_color" id="orange" value="#FFA952_white_Orange">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="app_cat_color" id="blue" value="#47AEF0_white_Blue">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="app_cat_color" id="purple" value="#AC7ADD_white_Purple">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="app_cat_color" id="green" value="#7EB476_white_Green">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="app_cat_color" id="yellow" value="#F5EA7E_#736A6B_Yellow">
