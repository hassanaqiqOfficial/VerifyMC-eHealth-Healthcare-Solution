       ...
       <div class="page-header page-header-light">
              <div class="page-header-content header-elements-md-inline">
                  <div class="d-flex page-title pb-2 pt-2">
                      <h4> <span class="font-weight-semibold">Add Service</span></h4>
	    ...
	    <section class="content">
          <div class="card">
            ...
            <div class="card-body">
                    ...
                    <form  class="form-groups-bordered admin-form-validate" action="" method="post" enctype="multipart/form-data" id="myform">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 col-lg-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2 col-lg-2" style="font-size:14px;">Category <span class="text-danger dark"> * </span></label>
                                    <div class="col-lg-6 col-md-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2 col-lg-2" style="font-size:14px;">Color <span class="text-danger dark"> * </span></label>
                                    <div class="col-lg-6 col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                    <textarea type="text" name="info"  placeholder="Start Typing here..." rows="7" class="form-control"></textarea>
                                    </div>
                                </div>
