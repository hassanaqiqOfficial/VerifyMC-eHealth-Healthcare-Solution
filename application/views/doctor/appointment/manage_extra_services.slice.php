        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="d-flex page-title pb-2 pt-2">
                    <h4> <span class="font-weight-semibold">Extra Services</span></h4>
                    <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
                </div>
                <div class="header-elements d-none">
                    <div class="d-flex justify-content-center">
                        <a href="<?=base_url("doctor/appointment/add_extra_service");?>" class="btn btn-outline-primary btn-sm" ><span>Add</span></a>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    patient_datatable = $("#datatable").DataTable({
        ...
        responsive: true,
            "ajax": {
            "url" : "<?= base_url("doctor/appointment/list_extra_services")?>",
            "type": "POST",
            "data": function ( d ) {
                 d.custom_filter = '';
            }
