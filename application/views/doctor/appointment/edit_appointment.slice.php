...
@section('content')
   ...
   <div class="content-wrapper">
      ...
      <section class="content">
       <form class="form-groups-bordered admin-form-validate" action="<?=base_url('doctor/appointment/edit_appointment/'.$appointment['pk_appointment_id']);?>" method="post" enctype="multipart/form-data" id="myform">
          <div class="card">
            <div class="card-body">
              <?=__message()?>  
                  <div class="row">
                        ...
                        <!--/Existing-patient Details here....  -->
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12 col-lg-12">
                                    <h4 class="title" style="font-weight:bold;">Select Date</h4>
                                    <hr style="margin-top:0px;margin-bottom: 20px;">
                                </div>
                            </div>
                             ...
                             <div class="from-row mb-2">
                               <div class="col-lg-12 col-md-12">
                                 <div class="from-group">
                                    ...
                                    ?> 
                                    <option value="<?=$service['pk_service_id'];?>" <?php if($service['pk_service_id'] == $appointment['fk_service_id']){echo "selected"; }?> ><?=$service['title'];?></option> 
                                    <?php } } ?>
                                </select>
                               </div>
                              </div>
                           ...
                           <div class="from-row mb-2">
                            <div class="col-lg-12 col-md-12">
                              <div class="from-group">  
                                <label class="input-label">Appointment Status <span class="text-danger dark"> * </span></label>
