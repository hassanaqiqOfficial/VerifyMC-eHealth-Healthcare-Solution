 ...
 <div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
           <div class="card-body">
              <?= __message();?>
                <form action="<?php echo base_url('doctor/profile/')?>" method="post" class="admin-form-validate form-horizontal" id="myform" enctype="multipart/form-data"> 
                    <div class="form-row">
                        <div class="col-lg-7 col-md-6">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-md-3">Name <span class="text-danger dark"> * </span></label>
                         ...
                         <div class="form-group row">
                           ...
                           <div class="form-group row">
                            ...
                            <div class="form-group row">
                               <label class="col-form-label col-lg-3 col-md-3">Website </label>
                                <div class="col-lg-8 col-md-8">
                      ...
                      <div class="form-group row">
                          <label class="col-form-label col-lg-3 col-md-3">Address</label>
                              <div class="col-lg-8 col-md-8">
                          ...
                          <div class="form-group row">
                           ...
                           <div class="form-group row">
                             <label class="col-form-label col-lg-3 col-md-3">EIN</label>
                               <div class="col-lg-8 col-md-8">
                          ...
                          <div class="form-group row">
                            <label class="col-form-label col-lg-3 col-md-3">Business Lic</label>
                              <div class="col-lg-8 col-md-8">
                    ...
                    <a href="<?=base_url("doctor");?>" class="btn btn-primary ml-2">Back</a>
                 </div>
                </form>
               </div>
             </section>
           ...
           <section class="content">
              <div class="card">
                  <div class="card-header header-element-inline">
                     ...
                     <div class="card-body">
                       <?= __message();?>
                          <form method="post" class="form-horizontal admin-form-validate_pass" action="<?php echo base_url('doctor/profile/update_password/'); ?>" id="myform2" enctype="multipart/form-data">
                               <div class="row">
