    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="d-flex page-title pb-2 pt-2">
                <h4><span class="font-weight-semibold"><?php if ($sms_template['title'] != "") {
                            echo $sms_template['title'];
                        } else {
            ...
            <form action="" method="post" class="admin-form-validate" enctype="mulipart/form-data" id="myform">
                <div class="card-body">
                    ...
                    <div class="form-row ">
                        <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12 ">
                            ...
                            <div class="form-gorup">
                                ...
                                <div class="">
                                    <label class="switch">   
                                        <input type="checkbox" name="is_notify_sms" value="1" <?php if($sms_template['is_notification'] == 1){ echo "checked"; } ?>>
                            ...
                            <div class="form-gorup mt-2">
                                ...
                                <div class="">
                                  <textarea name="body" class="form-control" rows="6" required id="body" placeholder="Start typing here..."><?= $sms_template['body']; ?></textarea>
                                </div>
                            </div>
                    ...
                    <div class="container mt-3">
                        <b>SMS Codes Available</b>
                        <hr style="mt-2 mb-2">
                        <b style="font-size: 12px;">You can use the codes located within the { } to include dynamic data
                            in you email. To add copy and paste the codes below into your email above.</b><br><br>
                        ...
                        <b>Patient Portal Login</b> {PatientPortalLogin} <br>
                    </div>
