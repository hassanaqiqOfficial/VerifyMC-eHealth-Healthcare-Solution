        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="<?=base_url('doctor/notifications/add_custom_email/'); ?>" class="btn btn-outline-primary btn-sm">+Add Custom Email</a>
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        custom_email_datatable = $("#datatable").DataTable({
            ...
            responsive: true,
            "ajax": {
                "url" : "<?= base_url("doctor/notifications/list_custom_email")?>",
                "type": "POST",
                "data": function ( d ) {
                    d.custom_filter = '';
                }
