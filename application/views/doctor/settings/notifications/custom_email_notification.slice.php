                    ...
                    <div class="form-row ">
                        ...
                        <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                            ...
                            <div class="form-gorup">
                                <label>Title<span class="text-danger dark"> * </span></label>
                                    <input type="text" name="template_title" value="<?= $custom_email['title']; ?>"
                                           class="form-control" required placeholder="Template Title"
                                           id="template_title">
                            </div>
                        
                            <div class="form-gorup">
                                <label>Subject<span class="text-danger dark"> * </span></label>
                                    <input type="text" name="subject" value="<?= $custom_email['subject']; ?>"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-2">
                            <div class="form-group">
                                ...
                                <div class="">
                                <textarea name="body" class="ckeditor" required id="body"><?= $custom_email['body']; ?></textarea>
                                </div>
                            </div>
                        </div>
