    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="d-flex page-title pb-2 pt-2">
                <h4><span class="font-weight-semibold">Manage Custom SMS</span></h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="<?= base_url('doctor/notifications/add_custom_sms/'); ?>"
                       class="btn btn-outline-primary btn-sm">+Add Custom SMS</a>
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function () {
        ...
        custom_sms_datatable = $("#datatable").DataTable({
            ...
            "aoColumnDefs": [
                    ...
                    {
                    ?>{
                    "bSortable": <?=$value["sort"]?>, "searchable": <?=$value["search"]?>, "aTargets": [<?=$i?>]
                },<?php
                $i++;
                }
                }?>
            ...
            responsive: true,
            "ajax": {
                "url": "<?= base_url("doctor/notifications/list_custom_sms")?>",
                "type": "POST",
                "data": function (d) {
                    d.custom_filter = '';
                }
