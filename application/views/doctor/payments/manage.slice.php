     ...
     <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="d-flex page-title pb-2 pt-2">
                <h4> <span class="font-weight-semibold">Manage Payments</span></h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
            <!-- <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="<?=base_url("doctor/invoices/invoice_payment");?>" class="btn btn-outline-primary btn-sm" ><span>Add Payment</span></a>
                </div>
            </div> -->
...
$(document).ready(function() {
    ...
    payment_datatable = $("#datatable").DataTable({
        ...
        drawCallback: function ( settings ) {
            ...
            api.column(2, {page:'current'} ).data().each( function ( group, i ) {
                if ( last !== group ) {
                    $(rows).eq( i ).before(
                        '<tr class="table-active"><td colspan="7" class="font-weight-semibold">'+group+'</td></tr>'
                    );
        ...
        responsive: true,
            "ajax": {
            "url" : "<?= base_url("doctor/invoices/list_payments")?>",
            "type": "POST",
            "data": function ( d ) {
                 d.custom_filter = '';
            }
