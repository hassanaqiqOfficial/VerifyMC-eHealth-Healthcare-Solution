...
@section('title', 'Manage Custom SMS')
@section('content')
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="header-elements d-none">
                ...
                <a href="<?=base_url('notifications/add_custom_sms/'); ?>" class="btn btn-outline-primary btn-sm">+Add Custom SMS</a>
...
$(document).ready(function() {
    ...
    custom_sms_datatable = $("#datatable").DataTable({
        ...
        responsive: true,
            "ajax": {
            "url" : "<?= base_url("notifications/list_custom_sms")?>",
            "type": "POST",
            "data": function(d) {
                 d.custom_filter = '';
            }
