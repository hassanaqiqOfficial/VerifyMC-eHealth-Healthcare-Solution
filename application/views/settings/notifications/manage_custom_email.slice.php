...
@section('title', 'Manage Custom Email')
@section('content')
   ...
   <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="d-flex page-title pb-2 pt-2">
                <h4> <span class="font-weight-semibold">Manage Custom Email</span></h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                <a href="<?=base_url('notifications/add_custom_email/'); ?>" class="btn btn-outline-primary btn-sm">+Add Custom Email</a>
...
$(document).ready(function() {
    ...
    custom_email_datatable = $("#datatable").DataTable({
        ...
        responsive: true,
            "ajax": {
            "url" : "<?= base_url("notifications/list_custom_email")?>",
            "type": "POST",
            "data": function ( d ) {
                 d.custom_filter = '';
            }
