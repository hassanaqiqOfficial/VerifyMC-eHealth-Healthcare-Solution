                ...
                <div class="form-row ">
                   ...
                   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
                       <div class="form-gorup">
                        ...
                        <div class="mb10">
                            <input type="text" name="template_title" value="<?=$custom_email['title'];?>" class="form-control" required placeholder="Template Title"
                                    id="template_title">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
                      <div class="form-gorup">
                        ...
                        <div class="mb10">
                            <input type="text" name="subject" value="<?=$custom_email['subject'];?>" class="form-control" required placeholder="Subject"
                                    id="subject">
                        </div>
                      </div>
                    </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="mb10">
                            <textarea name="body" class="ckeditor" required 
                                    id="body"><?=$custom_email['body'];?></textarea>
                        </div>
                      </div>
                    </div>
