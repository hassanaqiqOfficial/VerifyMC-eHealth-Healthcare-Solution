				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="header-elements d-none">
						<div class="d-flex justify-content-center">
							<button type="submit" class="btn btn-outline-primary btn-sm" form="myform">Submit</button>
               ...
               <div class="card-body">
                  <?=__message()?> 
                    <div class="row">
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group">
                                <label>Doctor Name <span class="text-danger dark"> * </span></label>
                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="clinic" id="clinic">
                                 <?php
                                  foreach ($clinic_data as $value) 
                                  {
                                 
                                 ?> 
                                  <option value="<?=$value['clinic_user_id'];?>"><?=$value['clinic_name'];?></option>
                                 <?php  } ?>
                                </select>  
                            </div>
                        </div>
                   ...
                   <div class="row">
                    ...
                    <a href="<?=base_url("admin/doctors/"); ?>" class="btn btn-primary">Back</a>
                </div>
            </form>
        ...
        validator.validate({
            ...
            rules: {
                ...
                user_name: {
                    ...
                    user_name: true, 
                    remote: {
                        url: "<?= base_url("admin/patient/validate_username")?>",
                        type: "post",
