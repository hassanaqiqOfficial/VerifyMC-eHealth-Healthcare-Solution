			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="d-flex page-title pb-2 pt-2">
						<h4> <span class="font-weight-semibold">Edit Clinic</span></h4>
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                <label>Profile </label>
                                <textarea class="ckeditor" name="profile_info" id="profile_info"><?=$clinic_data['clinic_profile_info']; ?></textarea>
                            </div>
                        </div>
                    </div>
                     <div class="row">
