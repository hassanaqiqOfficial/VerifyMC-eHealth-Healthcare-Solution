	   ...
	   this.startUpload = function () {
		...
		function noserializeAndUploadFiles(s, obj, files) {
		    var ts = s;
                ...
                var form = $("<div style='display:block; position:absolute;left: 150px;' class='" + obj.formGroup + "' method='" + s.method + "' action='" + s.url + "' enctype='" + s.enctype + "'></div>");
                form.appendTo('body');
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for(var i = 0; i < files.length; i++) {
				...
				pd.filename.html(fileNameStr);
                var form = $("<div style='display:block; position:absolute;left: 150px;' class='" + obj.formGroup + "' method='" + s.method + "' action='" +
                    s.url + "' enctype='" + s.enctype + "'></div>");
                form.appendTo('body');
                var fileArray = [];
                fileArray.push(files[i].name);
